...
.schedule-day{display:flex;flex-direction:column}.schedule-day-featured{min-height:76px;padding:0;border-top:1px solid var(--line)}.schedule-day-featured--empty{background:var(--paper)}.schedule-day-featured .schedule-featured{min-height:75px}.schedule-featured strong small{display:block;margin-top:.25rem;font-weight:400;line-height:1.3}
@media(max-width:760px){.schedule-scroll{overflow:visible}.schedule-grid,.schedule-featured-grid{display:block;min-width:0;border:0}.schedule-day{margin:0 0.15rem 1rem;border:1px solid var(--line)}.schedule-day:last-child{border-right:1px solid var(--line)}.schedule-day-track{height:auto;position:static}.schedule-card{position:static;height:auto!important;min-height:46px;border-top:0;border-bottom:1px solid var(--line)}.schedule-card:last-child{border-bottom:0}.schedule-card>.schedule-card__clickable{padding:.72rem .6rem;touch-action:pan-y}.schedule-featured{margin:.75rem 0}.schedule-card__line{grid-template-columns:minmax(104px,.62fr) minmax(0,1fr)}.schedule-empty{height:auto}}
